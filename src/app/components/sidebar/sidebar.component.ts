...
export const ROUTES: RouteInfo[] = [
    ...
    {path: '/tables', title: 'Consultar saldo', icon: 'ni ni-collection text-black', class: ''},
    {path: '/maps', title: 'Pedir emprestimo', icon: 'ni ni-chart-bar-32 text-black', class: ''},
    {path: '/dashboard', title: 'Pagamentos', icon: 'ni ni-ruler-pencil text-black', class: ''},
